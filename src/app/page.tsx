                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Nuestros médicos te brindarán un diagnóstico preciso y un tratamiento adecuado para tus
                      necesidades.
                    </p>
                  </CardContent>
                </Card>
              ...
              <ScrollAnimation delay={0.3}>
                <Card>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      Realizamos todo tipo de exámenes con equipos de última generación.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
        ...
        <section id="testimonios" className="w-full py-12 md:py-24">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              {[1, 2, 3].map((i) => (
                <ScrollAnimation key={i} delay={i * 0.1} direction="up">
                  <Card className="bg-muted/50">
                    <CardContent className="p-6">
                      <div className="flex flex-col gap-4">
                        <p className="italic text-muted-foreground">
                          "Excelente atención médica. El doctor fue muy amable y profesional. Recomiendo ampliamente
                          esta clínica."
                        </p>
                        <div className="flex items-center gap-2">
